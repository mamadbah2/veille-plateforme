 ...
 * 
 * <p>Cette configuration définit les métadonnées de l'API et 
 * le schéma de sécurité JWT pour Swagger UI.</p>
 * 
 * <p>Accès à la documentation :</p>
 * <ul>
...
@OpenAPIDefinition(
    info = @Info(
        title = "Horus - API de Veille Cybersécurité",
        version = "1.0.0",
        description = """
        ...
        contact = @Contact(
            ...
            email = "backend@ssi.sn"
        ),
        license = @License(
            name = "Propriétaire - Usage interne SSI",
            url = "https://ssi.sn/license"
        )
    ),
    servers = {
