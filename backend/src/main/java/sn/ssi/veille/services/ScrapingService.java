...
/**
 * Service responsable de la collecte (scraping) d'articles depuis différentes
 * sources.
...
public interface ScrapingService {
     ...
     *
     * @param source La configuration de la source contenant l'URL API et les clés
     *               nécessaires.
    ...
    /**
     * Collecte des articles via un flux RSS.
     *
     * @param source La configuration de la source contenant l'URL du flux RSS.
     * @return Une liste d'objets Article normalisés.
     */
    List<Article> scrapeViaRss(Source source);

    /**
     * Collecte des articles via scraping HTML.
     *
     * @param source La configuration de la source avec les sélecteurs CSS.
     * @return Une liste d'objets Article normalisés.
     */
     ...
     * @return Le nom de la catégorie déterminée (ex: "Vulnérabilité",
     *         "Cybercriminalité").
     */
    String categorizeArticle(Article article);

    /**
     * Détermine le niveau de gravité d'un article en fonction de mots-clés ou
     * métriques (CVSS).
     *
    ...
    /**
     * Teste l'intégration IA avec un contenu arbitraire.
     *
     * @param content Le contenu texte à analyser.
     * @return L'article enrichi (dummy).
     */
    Article testAI(String content);
